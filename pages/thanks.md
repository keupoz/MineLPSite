...
- Thanks to **oskarek11** who drew the image of Princess Celestia from which I borrowed the hair in [the header image]({{ '/assets/legacy/header.png' | relative_url }}){:target="_blank"}
